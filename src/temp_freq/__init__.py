...
#psutil = {'acpitz': [shwtemp(label='', current=6.8, high=18.8, critical=18.8), shwtemp(label='', current=27.8, high=119.0, critical=119.0), shwtemp(label='', current=29.8, high=119.0, critical=119.0)]
